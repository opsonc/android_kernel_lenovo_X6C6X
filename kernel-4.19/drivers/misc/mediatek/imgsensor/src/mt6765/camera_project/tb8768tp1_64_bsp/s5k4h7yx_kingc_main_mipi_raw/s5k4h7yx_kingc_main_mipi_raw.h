 ...
 * Filename:
 * ---------
 *	 s5k4h7yx_kingc_main_mipi_raw.h
 *
 * Project:
 * --------
 *	 ALPS
...
/* OTP FLAG TYPE */
#define S5K4H7YX_OTP_FLAG_EMPTY              0x00
#define S5K4H7YX_OTP_FLAG_VALID              0x01
#define S5K4H7YX_OTP_FLAG_INVALID            0x02
#define S5K4H7YX_OTP_FLAG_INVALID2           0x03
#define S5K4H7YX_OTP_GET_2BIT_FLAG(flag, bit)   ((flag >> bit) & 0x03)
