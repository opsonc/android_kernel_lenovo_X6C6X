...
#define SHORT_TEST_CSV_FILE "/mnt/ito/ShortTest.csv"
#define OPEN_TEST_CSV_FILE "/mnt/ito/OpenTest.csv"
#define FW_RAWDATA_CSV_FILE "/mnt/ito/FWMutualTest.csv"
#define FW_CC_CSV_FILE "/mnt/ito/FWCCTest.csv"
#define NOISE_TEST_CSV_FILE "/mnt/ito/NoiseTest.csv"
#define PEN_FW_RAW_TEST_CSV_FILE "/mnt/ito/PenFWRawTest.csv"
#define PEN_NOISE_TEST_CSV_FILE "/mnt/ito/PenNoiseTest.csv"
...
static uint8_t fw_ver = 0;
 extern struct proc_dir_entry *nvt_touch_proc_dir;
...
*/
		if(TestResult_Short == 0 && TestResult_Open == 0 && TestResult_FWMutual == 0 && TestResult_FW_CC == 0 && TestResult_FW_DiffMax == 0 && TestResult_Pen_FW_Raw == 0 && TestResult_Pen_Noise == 0){
...
{
	NVT_proc_selftest_entry = proc_create("ctp_openshort_test", 0444, nvt_touch_proc_dir, &nvt_selftest_fops);
