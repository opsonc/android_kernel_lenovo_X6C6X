...
struct charger_ops {
	...
	/* get charing status */
	int (*get_charging_status)(struct charger_device *dev, bool *en);

	int (*set_ship_mode)(struct charger_device *dev, bool en, bool delay);
	int (*get_charger_name)(struct charger_device *dev, const char **name);
};
