...
#endif
#if defined(OV8856_QTECH_MAIN_MIPI_RAW)
	{SENSOR_DRVNAME_OV8856_QTECH_MAIN_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 1},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC5035_KINGC_FRONT_MIPI_RAW)
	{SENSOR_DRVNAME_GC5035_KINGC_FRONT_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 1},
...
#endif
#if defined(S5K4H7YX_KINGC_MAIN_MIPI_RAW)
	{SENSOR_DRVNAME_S5K4H7YX_KINGC_MAIN_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 0},
			{DVDD, Vol_1200, 0},
...
#endif
#if defined(OV5675_OFILM_FRONT_MIPI_RAW)
	{SENSOR_DRVNAME_OV5675_OFILM_FRONT_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 1},
			{DOVDD, Vol_1800, 1},
