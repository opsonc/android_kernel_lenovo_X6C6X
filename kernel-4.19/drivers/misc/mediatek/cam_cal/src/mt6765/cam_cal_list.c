...
extern unsigned int ov8856_read_region(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);
struct stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	/*Below is commom sensor */
	{OV5675_OFILM_FRONT_SENSOR_ID, 0xA0, Common_read_region},
	{GC5035_KINGC_FRONT_SENSOR_ID, 0x6E, gc5035_read_region},
	{OV8856_QTECH_MAIN_SENSOR_ID, 0x6C, ov8856_read_region},
	{S5K4H7YX_KINGC_MAIN_SENSOR_ID, 0x5A, s5k4h7yx_read_region},
