...
extern int  is_hx_lcm;
extern bool islcd_connect;//{.compatible = "mediatek,cap_touch" },	{.compatible = "mediatek,touch" },	{.compatible = "himax,hxcommon" },
...
I("mtk_tpd: himax_tpd_rst_gpio_number = %d\n",himax_tpd_rst_gpio_number);
	msleep(100);
#if defined(HX_RST_PIN_FUNC)
	kp_tpd_gpio_output(himax_tpd_rst_gpio_number, 1);
	msleep(20);
	...
	I("mtk_tpd: himax_tpd_int_gpio_number = %d\n",himax_tpd_int_gpio_number);
	/* set INT mode */
